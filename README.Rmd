...
The goal of ggtfplot is to create plots of transcription factors on gene promoters

## Installation

You can install the development version of ggtfplot from [GitHub](https://github.com/) with:
